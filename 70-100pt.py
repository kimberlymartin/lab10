...
#The window panes
pane1a = drawpad.create_rectangle(240,230,275,265)
pane1b = drawpad.create_rectangle(240,265,275,300)
pane1c = drawpad.create_rectangle(275,230,310,265)
pane1d = drawpad.create_rectangle(275,265,310,300)
pane2a = drawpad.create_rectangle(240,400,275,435)
pane2b = drawpad.create_rectangle(240,435,275,470)
pane2c = drawpad.create_rectangle(275,400,310,435)
pane2d = drawpad.create_rectangle(275,435,310,470)
pane3a = drawpad.create_rectangle(490,230,525,265)
pane3b = drawpad.create_rectangle(490,265,525,300)
pane3c = drawpad.create_rectangle(525,230,560,265)
pane3d = drawpad.create_rectangle(525,265,560,300)
pane4a = drawpad.create_rectangle(490,400,525,435)
pane4b = drawpad.create_rectangle(490,435,525,470)
pane4c = drawpad.create_rectangle(525,400,560,435)
pane4d = drawpad.create_rectangle(525,435,560,470)
